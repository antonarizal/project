        ...
        <div class="table-responsive">
            <table class="table">
                <tr>
                    <td>Judul Buku</td>
                    <td>
                        <input required type="text" class="form-control" name="nama" value="{{ $buku->nama }}">
                    </td>
                </tr>
                <tr>
                    <td>Penulis</td>
                    <td>
                        <select name="penulis_id" id="" class="form-control">
                            ...
                            <option value="{{ $penulis->id }}" {{ $penulis->penulis_id == $penulis->id ? 'selected' : '' }}>{{ $penulis->penulis }}</option>
                ...
                <tr>
                    ...
                    <td>
                        <select name="penerbit_id" id="" class="form-control">
                            ...
                            <option value="{{ $penerbit->id }}" {{ $penerbit->penerbit_id == $penerbit->id ? 'selected' : '' }}>{{ $penerbit->penerbit }}</option>
                ...
                <tr>
                    ...
                    <td>
                        <select name="edisi_id" id="" class="form-control">
                            ...
                            <option value="{{ $edisi->id }}"  {{ $edisi->edisi_id == $edisi->id ? 'selected' : '' }}>{{ $edisi->edisi }}</option>
