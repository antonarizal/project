...
<main>
          ...
          <div class="container p-3">
            <nav>
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Bahasa Indonesia: Aku Bisa! untuk SD/MI Kelas I (Edisi Revisi)</li>
              </ol>
            </nav>
          </div>
        </section>
        <section>
          <div class="container p-4">
            <div class="row p-3 mb-5" style="background: url(&quot;img/backgroud.png&quot;) 100% / cover no-repeat; border-radius: 15px">
              <div class="col-lg-3 text-center d-flex align-items-center justify-content-center">
                <img src="{{ asset('img/Cover.png') }}" class="Hero _img-size__rtKi5" alt="" />
              </div>
              <div class="col-lg-9 pt-5 pt-md-0">
                ...
                <button class="btn btn-sm btn-orange py-2 me-3 my-2">
                  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="file-pdf" class="svg-inline--fa fa-file-pdf me-1" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                    <path
                      fill="currentColor"
                ...
                <small class="my-3 text-muted d-block">
                  <a data-bs-toggle="modal" data-bs-target="#reportModal" class="text-decoration-none text-blue ms-2 fw-bold" style="cursor: pointer">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-exclamation" class="svg-inline--fa fa-circle-exclamation" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                      <path
                        fill="currentColor"
                ...
                <div class="row align-items-center mb-3">
                  ...
                  <div class="col-5 col-lg-10 p-0"><hr /></div>
                </div>
                <div class="row">
        ...
        <section><div class="container p-3"></div></section>
        <section class="py-5">
          <div class="container p-3">
